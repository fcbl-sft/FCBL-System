...
const mapFromDb = (row: any): Project => ({
    ...
    styleNumber: row.style_number || undefined,
...
export const projectService = {
    ...
    async getProjects(): Promise<{ data: Project[] | null; error: string | null }> {
        try {
            // Ensure Supabase client has restored its internal session from
            // localStorage before making data queries. Without this, queries
