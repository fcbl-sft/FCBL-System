            ...
            <div className="max-w-2xl mx-auto p-6">
                ...
                <form onSubmit={handleSubmit}>
                        ...
                        <div className="p-6 space-y-4">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full px-4 py-3 border focus:outline-none focus:border-green-600 transition-colors"
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    disabled={isEditing}
                                    className={`w-full px-4 py-3 border transition-colors ${isEditing ? 'bg-gray-50' : 'focus:outline-none focus:border-green-600'}`}
                                    style={{ fontSize: '13px', borderColor: '#E0E0E0' }}
                                    required={!isEditing}
                                />
                                {isEditing && (
                        ...
                        <div className="p-6">
                            ...
                            <div className="mb-6">
                                ...
                                <select
                                    ...
                                    className="w-full px-4 py-3 border focus:outline-none focus:border-green-600"
                                    style={{ fontSize: '13px', borderColor: '#E0E0E0' }}
                                >
                    ...
                    <div className="flex gap-4">
                        ...
                        <button
                            type="submit"
                            className="flex-1 py-3 btn-primary transition-colors flex items-center justify-center gap-2"
                            style={{ fontSize: '12px', fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.5px' }}
                            disabled={isSaving}
                        >
