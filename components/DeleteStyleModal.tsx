...
const DeleteStyleModal: React.FC<DeleteStyleModalProps> = ({
    ...
    return (
        ...
        >
            <div
                className="bg-white w-full sm:rounded-lg sm:max-w-md sm:mx-4 shadow-xl"
            ...
            >
                ...
                {/* Footer */}
                <div className="flex flex-col-reverse sm:flex-row sm:justify-end gap-3 px-6 py-4 border-t border-gray-200 bg-gray-50 rounded-b-lg">
                    <button
                        onClick={onCancel}
                    ...
                    <button
                        onClick={onConfirm}
                        className="w-full sm:w-auto px-4 py-3 sm:py-2 text-sm font-medium text-white bg-red-600 rounded hover:bg-red-700 transition-colors"
                    >
                        Delete
                    </button>
                </div>
