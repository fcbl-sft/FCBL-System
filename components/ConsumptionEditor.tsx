            ...
            <div className="flex-grow overflow-y-auto p-6">
                <div className="max-w-7xl mx-auto space-y-6">
                    ...
                    <div className="bg-white border border-gray-200 overflow-hidden">
                        <div className="fcbl-header-bar px-6 py-4">
                    ...
                    <div className="bg-white border border-gray-200 overflow-hidden">
                        <div className="fcbl-header-bar px-6 py-3">
                            <div>
                                <h2 className="text-white font-bold text-sm uppercase tracking-wider flex items-center gap-2">
                                                        ...
                                                        <tr key={item.id}>
                                                            <td className="border border-gray-300 px-2 py-1">
                                                                <select
                                                                    ...
                                                                    className="w-full p-2 border-0 bg-transparent focus:ring-2 focus:ring-green-600"
                                                                >
                                                            ...
                                                            <td className="border border-gray-300 px-2 py-1">
                                                                <input
                                                                    ...
                                                                    className="w-full p-2 text-center border-0 bg-transparent focus:ring-2 focus:ring-green-600"
                                                                    min="0"
                                                                    max="100"
                                                                />
                                                            </td>
                                                    ...
                                                    <tr key={item.id}>
                                                        ...
                                                        <td className="border border-gray-300 px-2 py-1">
                                                            <select
                                                                ...
                                                                className="w-full p-2 border-0 bg-transparent focus:ring-2 focus:ring-green-600 text-center"
                                                            >
                    ...
                    <div className="bg-white border border-gray-200 overflow-hidden">
                        ...
                        <div className="p-6">
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                ...
                                {/* Grand Total */}
                                <div className="text-white p-5 fcbl-header-bar">
