      ...
      <header className="bg-white border-b border-gray-200 px-6 py-4 flex justify-between items-center shrink-0 z-30 no-print">
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 fcbl-icon-box text-white flex items-center justify-center shadow-lg">
      ...
      <div className="flex-grow flex overflow-hidden">
        ...
        <main className="flex-grow overflow-y-auto bg-slate-50 p-8 space-y-8">
          <div className="grid grid-cols-4 gap-6 no-print">
            <div className="text-white p-6 shadow-lg flex items-center gap-5 fcbl-header-bar">
              ...
              <table className="w-full border-collapse">
                ...
                <tbody className="divide-y divide-slate-100">
                  {calculatedData.rows.map(row => (
                    <tr key={row.id} className="hover:bg-slate-50 transition-colors group">
                      ...
                      <td className="p-2">
                        <input type="number" className="w-full bg-white border border-gray-200 rounded p-2 text-xs text-center font-normal" value={row.totalBoxes} onChange={e => updateBoxDetail(row.id, 'totalBoxes', parseInt(e.target.value) || 0)} />
                      </td>
                      <td className="p-2">
                        <input type="number" className="w-full bg-white border border-gray-200 rounded p-2 text-xs text-center font-normal" value={row.unitsPerBox} onChange={e => updateBoxDetail(row.id, 'unitsPerBox', parseInt(e.target.value) || 0)} />
                      </td>
                      <td className="p-2">
                      ...
                      <td className="p-2">
                        <select className="w-full bg-white border border-gray-200 rounded p-2 text-xs text-center font-normal" value={row.size} onChange={e => updateBoxDetail(row.id, 'size', e.target.value)}>
                ...
                <tfoot className="bg-slate-50 border-t-2 border-slate-200 font-black text-slate-800 text-center uppercase">
                  <tr>
                    ...
                    <td className="p-4 text-sm text-green-700">{calculatedData.totalCartons}</td>
                    <td></td>
                    <td></td>
                    <td></td>
                    <td></td>
                ...
                <tbody className="divide-y divide-slate-100">
                  {calculatedData.summaryRows.map((row, i) => (
                    <tr key={i} className="text-center hover:bg-slate-50 transition-colors">
                      ...
                      <td className="p-4 font-black text-sm text-green-700 bg-gray-50">{row.total.toLocaleString()}</td>
                    </tr>
                  ))}
                </tbody>
          ...
          <div className="mt-12 pt-10 border-t-2 border-slate-200 no-print pb-32">
            <h3 className="text-xl font-black uppercase tracking-tighter text-slate-800 mb-8 flex items-center gap-3">
              <span className="w-8 h-8 fcbl-icon-box text-white rounded flex items-center justify-center text-xs">PL</span>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="bg-white p-8 border border-gray-200 flex flex-col h-[500px]">
                <div className="flex justify-between items-center mb-6">
                  <h4 className="font-black text-xs uppercase tracking-widest text-slate-400 flex items-center gap-2">
                    <MessageSquare className="w-4 h-4 text-green-600" /> Packing Notes Log
                  </h4>
                  <span className="text-[10px] font-black text-green-700 bg-green-50 px-2 py-1 rounded">{(packing.comments || []).length} Records</span>
                </div>
              ...
              <div className="bg-white p-8 border border-gray-200 flex flex-col h-[500px]">
                <div className="flex justify-between items-center mb-6">
                  <h4 className="font-black text-xs uppercase tracking-widest text-slate-400 flex items-center gap-2">
                    <Paperclip className="w-4 h-4 text-green-600" /> Audit Documentation
                  </h4>
                  <div>
                ...
                <div className="mt-8 p-4 bg-green-50 rounded border border-green-100">
                  <p className="text-[9px] font-black uppercase text-green-600 tracking-tighter mb-1">Logistics Note</p>
            ...
            <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm print:relative print:p-0 print:bg-white">
              <div className="bg-white w-full max-w-[210mm] max-h-[95vh] rounded-lg shadow-2xl overflow-hidden flex flex-col print:max-w-none print:max-h-none print:shadow-none print:rounded-none">
                <div className="p-4 border-b border-slate-200 flex justify-between items-center bg-gray-50 no-print">
                  ...
                  <div className="flex gap-2">
                    <button onClick={handlePrint} className="flex items-center gap-2 bg-green-600 text-white px-4 py-2 rounded-lg font-black text-xs uppercase shadow-lg hover:bg-green-700">
