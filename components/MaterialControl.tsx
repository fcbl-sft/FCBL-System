...
const MaterialControl: React.FC<MaterialControlProps> = ({ project, onUpdateProject, onUpdate, onBack }) => {
  ...
  const cellInputClass = "w-full bg-white border border-gray-100 focus:border-green-600 p-2 text-[11px] outline-none transition-colors placeholder:text-gray-400 font-normal rounded";
    ...
    <div className="flex flex-col h-full bg-gray-50 print:bg-white">
      <header className="bg-white border-b border-gray-200 px-6 py-4 flex justify-between items-center shrink-0 z-30 no-print">
        ...
        <div className="flex gap-2">
          ...
          {!isLocked && (
            <button onClick={() => addRow()} className="flex items-center gap-2 btn-primary font-black shadow-md transition-all">
              <Plus className="w-4 h-4" /> Add Custom Field
            </button>
          )}
          {!isLocked && (
            <button onClick={handleSave} className="flex items-center gap-2 btn-primary font-black shadow-md transition-all">
      ...
      <main className="flex-grow p-8 overflow-y-auto relative bg-gray-50/50 print:p-0 print:bg-white">
        <div className="w-full space-y-8 pb-32 no-print">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <button
              ...
              className={`p-6 border transition-all flex items-center gap-5 text-left group shadow-sm ${activeFilter === 'FULFILLED' ? 'bg-green-600 border-green-600 text-white ring-4 ring-green-100' : 'bg-white border-gray-100 hover:border-gray-300'}`}
            >
              ...
              <div className="flex items-center gap-4 flex-grow max-w-xl">
                <div className="relative flex-grow">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-3 bg-gray-50 border border-gray-200 text-sm outline-none focus:ring-2 focus:ring-green-600/20 focus:border-green-600 transition-all font-medium"
                    value={searchTerm}
                        ...
                        <td className="p-2 border-r border-gray-50 text-center">
                          ...
                          >
                            ...
                            {item.attachments?.length > 0 && (
                              <span className="absolute -top-1 -right-1 w-4 h-4 fcbl-icon-box text-white text-[8px] font-black flex items-center justify-center">
          ...
          <div className="mt-12 pt-10 border-t-2 border-slate-200">
            <h3 className="text-xl font-black uppercase tracking-tighter text-slate-800 mb-8 flex items-center gap-3">
              <span className="w-8 h-8 fcbl-icon-box text-white rounded flex items-center justify-center text-xs">MQ</span>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="bg-white p-8 rounded border border-gray-200 flex flex-col h-[500px]">
                <div className="flex justify-between items-center mb-6">
                  <h4 className="font-black text-xs uppercase tracking-widest text-slate-400 flex items-center gap-2">
                    <MessageSquare className="w-4 h-4 text-green-600" /> Audit Log
                  </h4>
                  <span className="text-[10px] font-black text-green-700 bg-green-50 px-2 py-1 rounded">{(project.materialComments || []).length} Comments</span>
                </div>
                    ...
                    <div key={c.id} className="bg-gray-50 border border-gray-200 p-4 rounded relative group">
                      <div className="flex justify-between items-start mb-2">
                        ...
                        <div className="flex gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                          <button onClick={() => startEditGlobalComment(c)} className="p-1 text-slate-400 hover:text-green-700"><Edit3 className="w-3.5 h-3.5" /></button>
                ...
                <div className="mt-auto">
                  ...
                  <button
                    ...
                    className="w-full btn-primary py-3 rounded-xl font-black text-[10px] tracking-widest flex items-center justify-center gap-2"
                  >
              ...
              <div className="bg-white p-8 rounded border border-gray-200 flex flex-col h-[500px]">
                <div className="flex justify-between items-center mb-6">
                  <h4 className="font-black text-xs uppercase tracking-widest text-slate-400 flex items-center gap-2">
                    <Paperclip className="w-4 h-4 text-green-600" /> Reference Documents
                  </h4>
                  <button
            ...
            <div className="bg-white w-full max-w-lg rounded shadow-xl flex flex-col overflow-hidden">
              ...
              <div className="p-6 bg-white border-t">
                <button
                  ...
                  className="w-full bg-green-600 text-white py-3 rounded-2xl font-black text-xs uppercase tracking-widest shadow-xl shadow-green-100 hover:bg-green-700 transition-all flex items-center justify-center gap-2"
                >
        ...
        {showPreview && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-8 bg-black/60 backdrop-blur-sm print:relative print:p-0 print:bg-white print:z-0">
            <div className="bg-white w-full max-w-6xl max-h-[90vh] rounded shadow-xl overflow-hidden flex flex-col print:max-w-none print:max-h-none print:shadow-none">
              ...
              <div id="mq-preview-content" className="p-10 overflow-y-auto bg-white flex-grow print:overflow-visible print:p-4">
                ...
                <div className="grid grid-cols-4 gap-4 mb-10">
                  ...
                  <div className="border-2 border-green-700 p-4 text-center fcbl-header-bar">
                      ...
                      {items.map(item => {
                        ...
                        return (
                          <tr key={item.id} className="text-[11px]">
                            ...
                            <td className="p-3 text-center font-bold text-green-700">{item.totalWeight}kg</td>
