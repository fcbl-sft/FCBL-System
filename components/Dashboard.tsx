              ...
              <div className="absolute top-full left-0 mt-1 bg-white border border-gray-200 shadow-lg rounded-lg py-1 z-50 min-w-[220px] max-h-[400px] overflow-y-auto">
                ...
                {MAIN_STAGES.map(stage => (
                  <div key={stage}>
                    ...
                    >
                      <span className={`w-4 h-4 border rounded flex items-center justify-center ${selectedStatuses.includes(stage) ? 'bg-green-600 border-green-600' : 'border-gray-300'}`}>
                ...
                {APPROVAL_STATUSES.map(status => (
                  <button
                    ...
                    className="w-full text-left px-3 py-1.5 text-xs font-medium hover:bg-gray-50 flex items-center gap-2"
                  >
                    <span className={`w-4 h-4 border rounded flex items-center justify-center ${selectedStatuses.includes(status) ? 'bg-green-600 border-green-600' : 'border-gray-300'}`}>
                ...
                <div className="border-t border-gray-100 mt-1 pt-1">
                  <button
                    ...
                    className="w-full text-left px-3 py-1.5 text-xs font-medium hover:bg-gray-50 flex items-center gap-2"
                  >
                    <span className={`w-4 h-4 border rounded flex items-center justify-center ${selectedStatuses.length === ALL_STATUS_OPTIONS.length ? 'bg-green-600 border-green-600' : 'border-gray-300'}`}>
                  ...
                  <>
                    {uniqueTeams.map(team => (
                      <button
                        ...
                        className="w-full text-left px-3 py-1.5 text-xs font-medium hover:bg-gray-50 flex items-center gap-2"
                      >
                        <span className={`w-4 h-4 border rounded flex items-center justify-center ${selectedTeams.includes(team) ? 'bg-green-600 border-green-600' : 'border-gray-300'}`}>
                    ...
                    <div className="border-t border-gray-100 mt-1 pt-1">
                      <button
                        ...
                        className="w-full text-left px-3 py-1.5 text-xs font-medium hover:bg-gray-50 flex items-center gap-2"
                      >
                        <span className={`w-4 h-4 border rounded flex items-center justify-center ${selectedTeams.length === uniqueTeams.length ? 'bg-green-600 border-green-600' : 'border-gray-300'}`}>
                  ...
                  <>
                    {uniqueBrands.map(brand => (
                      <button
                        ...
                        className="w-full text-left px-3 py-1.5 text-xs font-medium hover:bg-gray-50 flex items-center gap-2"
                      >
                        <span className={`w-4 h-4 border rounded flex items-center justify-center ${selectedBrands.includes(brand) ? 'bg-green-600 border-green-600' : 'border-gray-300'}`}>
                    ...
                    <div className="border-t border-gray-100 mt-1 pt-1">
                      <button
                        ...
                        className="w-full text-left px-3 py-1.5 text-xs font-medium hover:bg-gray-50 flex items-center gap-2"
                      >
                        <span className={`w-4 h-4 border rounded flex items-center justify-center ${selectedBrands.length === uniqueBrands.length ? 'bg-green-600 border-green-600' : 'border-gray-300'}`}>
                  ...
                  <>
                    {uniqueFactories.map(factory => (
                      <button
                        ...
                        className="w-full text-left px-3 py-1.5 text-xs font-medium hover:bg-gray-50 flex items-center gap-2"
                      >
                        <span className={`w-4 h-4 border rounded flex items-center justify-center ${selectedFactories.includes(factory) ? 'bg-green-600 border-green-600' : 'border-gray-300'}`}>
                    ...
                    <div className="border-t border-gray-100 mt-1 pt-1">
                      <button
                        ...
                        className="w-full text-left px-3 py-1.5 text-xs font-medium hover:bg-gray-50 flex items-center gap-2"
                      >
                        <span className={`w-4 h-4 border rounded flex items-center justify-center ${selectedFactories.length === uniqueFactories.length ? 'bg-green-600 border-green-600' : 'border-gray-300'}`}>
      ...
      <main className="bg-white">
        ...
        {filteredProjects.length > 0 ? (
          ...
          <div className="text-center py-20">
            ...
            <button
              onClick={onCreateTechPack}
              className="mt-4 px-4 py-2 btn-primary text-sm font-bold rounded"
            >
              Create New Style
            </button>
          </div>
