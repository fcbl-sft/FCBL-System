...
const InputPanel: React.FC<InputPanelProps> = ({ data, previousData, onChange, onAutoFill, isAnalyzing, readOnly = false }) => {
  ...
  const baseInputClass = "w-full border border-gray-300 rounded px-2 py-1.5 text-sm focus:ring-1 focus:ring-green-600 focus:border-green-600";

  return (
    <div className="h-full flex flex-col">
      <div className="p-5 border-b border-gray-200 bg-gray-50">
        <h2 className="text-xl font-bold font-display text-gray-800 flex items-center gap-2">
          <span className="w-8 h-8 fcbl-icon-box text-white flex items-center justify-center text-xs rounded">GP</span>
          GenPack Editor
        </h2>
             ...
             {!readOnly && (
                <>
                    <button 
                        ...
                        className="flex items-center gap-1 btn-primary text-xs px-2 py-1 rounded transition-colors"
                    >
